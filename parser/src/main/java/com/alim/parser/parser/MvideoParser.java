package com.alim.parser.parser;

import com.alim.parser.entity.CategoryEntity;
import com.alim.parser.entity.ProductEntity;
import com.alim.parser.exception.ShopException;
import com.alim.parser.repositories.CategoryRepository;
import com.alim.parser.repositories.ProductRepository;
import com.alim.parser.util.BrowserUtil;
...
import static com.alim.parser.util.BrowserUtil.isScrolledPage;
import static com.alim.parser.util.BrowserUtil.scrollDown;
...
public class MvideoParser {
     ...
     */
    protected static final String[] IGNORE_TARGET = {"apple", "samsung", "акци", "кэш", "скидк", "распродаж", "premium", "лучш"};
    /**
     * Check products only with price
     */
    private static final String ONLY_PRICES_ON = "/f/tolko-v-nalichii=da";
    /**
    ...
    public static final String SHOP_NAME_MVIDEO = "https://www.mvideo.ru";
    private static final String MAIN_LINK = "https://www.mvideo.ru/catalog?from=under_search";
    private static final String MAIN_CATEGORY_XPATH_FORMAT = "//a[text()[contains(.,'%s')]]/parent::h3/parent::div/div[@class='c-catalog-item__links']/div/a";

    private static final String XPATH_SUBCATEGORY = "//div[@class='sidebar-categories-wrapper']/ul/li/a";
    private static final String XPATH_SHOW_ALL_SUBCATEGORY_BUTTON = "//a[@class='expandable-list-link']";

    private static final String XPATH_PRODUCT_TITLE_PATTERN = "//div[@class='product-title product-title--grid']/a";
    private static final String XPATH_PRODUCT_PRICE_PATTERN = "//span[@class='price__main-value']";
    private static final String XPATH_PRODUCT_PAGES = "//mvid-pagination/ul/li/a[text()[contains(.,*)]]";
    private static final String XPATH_PRODUCT_END_OF_PAGE_FROM = "//div[@class='bottom-controls']";
...
//    @PostConstruct
    ...
    public void parseMainCategoryPage() {
        ...
        for (WebElement element : mainCategories) {
            ...
            String xpath = MAIN_CATEGORY_XPATH_FORMAT.replace("%s", mainCategoryText);
                ...
                for (WebElement element : subCategories) {
                    ...
                    if (!subcategoryText.equals("- Скрыть")) {
                        ...
                        if (!subCategoryLink.contains("/f/")) {
                            ...
                            subCategoryLink += ONLY_PRICES_ON + "?" + SHOW_COUNT_72;
